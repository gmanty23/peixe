...
def conectar_nodos_hungaro(grafo, pesos, umbral_coste=np.inf):
    ...
    for nodo in nodos_f0:
        ...
        historico_centroides[track_id_counter].append(nodo["centroid"])
        track_id_counter += 1
    ...
    for i in range(len(frames) - 1):
        ...
        for j, n2 in enumerate(nodos_f2):
            if j not in asignados_f2:
                ...
                historico_centroides[track_id_counter].append(n2["centroid"])
                track_id_counter += 1
...
if __name__ == "__main__":
    ...
    labels_path = "/home/gmanty/code/output_20s/tracking/tracking_pez2/labels"
    ...
    guardar_frames_con_ids(
        ...
        path_imagenes_originales="/home/gmanty/code/output_20s/images_yolov8",
        path_salida="/home/gmanty/code/output_20s/prueba_salida_grafo_sin_tapar",
        image_size=1024
    )
