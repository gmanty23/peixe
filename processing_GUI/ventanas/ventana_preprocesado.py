...
from processing_GUI.procesamiento.preprocesado import  extraer_imagenes, redimensionar_imagenes
...
class WorkerThread(QThread):
    ...
    def __init__(self, video_path, redimensionar_flag, output_path, width=None, height=None):
        super().__init__()
        ...
        try:
            ...
            if self.redimensionar_flag:
                ...
                if self.cacelar_flag:
                    ...
                    return
                if images_path is None:
                    self.etapa_actual_signal.emit("Error al redimensionar las imágenes.")
                    return
...
class VentanaPreprocesado(QWidget):
    ...
    def __init__(self):
        ...
        # Etiqueta para mmostrar el nombre del archivo seleccionado
        self.label_video = QLabel("No se ha seleccionado ningún archivo", self)
    ...
    def cargar_rutas_guardadas(self):
        ...
        if ultima_ruta_video:
            self.label_video.setText(f"Archivo seleccionado: {ultima_ruta_video}")
    ...
    def seleccionar_video(self):
        ...
        if video:
            ...
            self.label_video.setText(f"Archivo seleccionado: {video}")
    ...
    def toggle_iniciar_preprocesado(self):
        ...
        if self.worker_thread and self.worker_thread.isRunning():
            ...
            video_path = self.label_video.text().split(":")[1].strip()
            ...
            if video_path and output_path:
                ...
                self.worker_thread = WorkerThread(video_path, redimensionar_flag, output_path, width, height)
    ...
    def mostrar_resultado(self, resultado):
        #Mostrar el resultado en un QLabel
        self.label_video.setText(resultado)
        self.boton_iniciar_preprocesado.setText("Iniciar Preprocesado")
